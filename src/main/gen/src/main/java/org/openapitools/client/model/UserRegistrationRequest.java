...
public class UserRegistrationRequest {
  ...
  static {
    ...
    openapiFields.add("passwordRepeat");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("email");
    openapiRequiredFields.add("password");
    openapiRequiredFields.add("passwordRepeat");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("passwordRepeat").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `passwordRepeat` to be a primitive type in the JSON string but got `%s`", jsonObj.get("passwordRepeat").toString()));
      }
  }
